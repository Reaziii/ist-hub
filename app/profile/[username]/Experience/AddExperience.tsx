                                        ...
                                        <div className='w-[600px] box-border p-5 pt-5'>
                                            ...
                                            <div className='mt-2 flex w-full gap-2'>
                                                <div className='w-[50%]'>
                                                    ...
                                                    <Input name='start_date' onChange={handleChange} value={values.start_date.toString()} error={errors.start_date} show={touched.start_date ? true : false} className="w-full box-border" type='date' />
                                                </div>
                                            ...
                                            <div className="flex items-center mb-4">
                                                ...
                                                <label className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I am still a working there</label>
                                            </div>
                                        </div>
...
const AddExperience: FC<{ add: (params: ExperieneInterfaces) => Promise<void> }> = ({ add }) => {
