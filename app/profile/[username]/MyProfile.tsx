import { extractDetails, extractEmailAddress, user } from '@/lib/user'
...
import { getProfileDetails, updateAbout, updateNameAndBio, uploadProfilePicture } from '@/lib/profile';
